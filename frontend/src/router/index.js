...
const routes = [
  { path: '/login', name: 'login', component: () => import('../views/Login.vue') },
  {
    ...
    redirect: '/dashboard',
    children: [
      { path: 'dashboard', name: 'dashboard', component: () => import('../views/Dashboard.vue'), meta: { titleKey: 'nav.dashboard', icon: 'DataAnalysis' } },
      { path: 'ads', name: 'ads', component: () => import('../views/Ads.vue'), meta: { titleKey: 'nav.ads', icon: 'Promotion' } },
      { path: 'ad-manager', name: 'ad-manager', component: () => import('../views/AdManager.vue'), meta: { titleKey: 'nav.ad-manager', icon: 'Operation' } },
      { path: 'launch-templates', name: 'launch-templates', component: () => import('../views/LaunchTemplates.vue'), meta: { titleKey: 'nav.launch-templates', icon: 'Promotion' } },
      ...
      { path: 'logs', name: 'logs', component: () => import('../views/AuditLog.vue'), meta: { titleKey: 'nav.logs', icon: 'Document' } },
      { path: 'settings', name: 'settings', component: () => import('../views/Settings.vue'), meta: { titleKey: 'nav.settings', icon: 'Setting' } },
      { path: 'members', name: 'members', component: () => import('../views/Members.vue'), meta: { titleKey: 'nav.members', icon: 'User' } },
      { path: 'tokens', name: 'tokens', component: () => import('../views/Tokens.vue'), meta: { titleKey: 'nav.tokens' } },
    ],
  },
]
