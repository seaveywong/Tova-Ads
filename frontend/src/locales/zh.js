...
export default {
  ...
  adm: {
    ...
    srBtn: '复制消耗账户', srBtnTip: '按当前筛选（日期段/账户多选/平台）生成行级数据：在管账户实时拉 FB 消耗，已移除账户取库内最后记录', srLoading: '拉取中…',
    srTitle: '消耗账户报告（{range}）', srMeta: '实时 {live} 个 · 库内 {db} 个（复制为 5 列制表符文本，可直接粘贴到表格）',
    srDate: '日期', srOwner: '归属人', srAccName: '账户名', srAccId: '账户ID', srSpend: '消耗金额(USD)', srSource: '来源', srStatus: '状态',
    srLive: '实时', srDb: '库内', srDbLast: '库内·最后', srNone: '无记录', srManaged: '在管', srRemoved: '已移除',
    srCopy: '复制', srCopied: '已复制 {n} 行', srEmpty: '当前筛选无账户',
