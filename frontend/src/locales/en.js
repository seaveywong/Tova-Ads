...
export default {
  ...
  adm: {
    ...
    refreshTip: 'Full reload: refreshes campaigns + adsets + ads (runs 1-2 min in background, auto-updates). For an instant on/off status check only, use "⚡ Live Verify" in the toolbar',
    liveVerify: 'Live Verify', liveVerifying: 'Verifying…', liveVerifyTip: 'Checks ad on/off status only (instant, bypasses cache, patches the status switches) — does NOT reload names/creatives/spend. For a full three-layer reload use "Refresh" in the header',
