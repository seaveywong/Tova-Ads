...
class PageCategoryIn(BaseModel):
    page_id: str
    category: str  # FB Page 类别（如 "Internet Marketing Service"）


@router.post("/credentials/{cred_id}/pages/category")
def set_page_category(
    ...
    """改主页类型/类别（page token 的 POST /{page} category 字段）。
    需该页 pages_manage_metadata 权限（code283 友好提示）——与订阅 webhook 同权限。"""
